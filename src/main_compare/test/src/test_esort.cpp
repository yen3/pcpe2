...
TEST(esort, test_esort_sort_file_2) {
    copy_seq_file("./testdata/esort_input_1.in",
                  "./testoutput/esort_input_1.out");
    copy_seq_file("./testdata/esort_input_2.in",
                  "./testoutput/esort_input_2.out");
    copy_seq_file("./testdata/esort_input_3.in",
                  "./testoutput/esort_input_3.out");
...
TEST(esort, test_esort_sort_files) {
    copy_seq_file("./testdata/esort_input_1.in",
                  "./testoutput/esort_output_1.out");
    copy_seq_file("./testdata/esort_input_2.in",
                  "./testoutput/esort_output_2.out");
    copy_seq_file("./testdata/esort_input_3.in",
                  "./testoutput/esort_output_3.out");
